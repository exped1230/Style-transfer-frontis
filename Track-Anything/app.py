...
def sam_refine(video_state, point_prompt, click_state, interactive_state, evt:gr.SelectData):
    ...
    h, w = video_state['origin_images'][0].shape[:2]
    f = open('info.txt', 'w')
    f.write('{}\n'.format(video_state['video_name']))
    f.write('{} {}\n'.format(h, w))
    f.close()
...
def inpaint_video(video_state, interactive_state, mask_dropdown):
    ...
    shutil.copy('./result/inpaint/{}'.format(video_state["video_name"]), '../TokenFlow/data/'+video_name+'_inpaint.mp4')
